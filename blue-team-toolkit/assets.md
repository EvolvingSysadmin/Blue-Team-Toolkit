...
* Incident Response
  * [Incident Response Lifecycle](assets.md#incident-response-lifecycle)
  * [MITRE ATT\&CK Framework](assets.md#mitre-attck-framework)
* Network Analysis
  * [Basic Network Tools](assets.md#basic-network-tools)
  * [Basic Port Info](assets.md#basic-port-info)
  * [NMAP](assets.md#nmap)
  * [Wireshark](assets.md#wireshark)
* Phishing Analysis
  * [Basic Email Info](assets.md#basic-email-info)
  * [Email Headers](assets.md#email-headers)
* Systems Forensics
  * [Digital Evidence Handling](assets.md#digital-evidence-handling)
  * [Basic File Metadata](assets.md#basic-file-metadata)
  * [File Hashing](assets.md#file-hashing)
  * [File Systems](assets.md#file-systems)
  * [Memory File Analysis](assets.md#memory-file-analysis)
  * [Windows Artifacts](assets.md#windows-artifacts)
  * [Linux Artifacts](assets.md#linux-artifacts)
  * [FTK Imager](assets.md#ftk-imager)
  * [Exiftool](assets.md#exiftool)
  * [Scalpel](assets.md#scalpel)
  * [KAPE](assets.md#kape)
  * [Windows File Analyzer](assets.md#windows-file-analyzer)
  * [Prefetch Explorer Command Tool PECmd.exe](assets.md#prefetch-explorer-command-tool-pecmdexe)
  * [JumpList Explorer](assets.md#jumplistexplorer)
  * [Browser History Viewer](assets.md#browser-history-viewer)
  * [Browser History Capturer](assets.md#browser-history-capturer)
  * [John the Ripper](assets.md#john-the-ripper)
  * [Steghide](assets.md#steghide)
  * [Volatility](assets.md#volatility)
  * [Autopsy](assets.md#autopsy)
  * [YARA](assets.md#yara)
* Security Information and Event Monitoring
  * [Log Review Approach](assets.md#log-review-approach)
  * [Windows Log Analysis](assets.md#windows-log-analysis)
  * [Linux Log Analysis](assets.md#linux-log-analysis)
  * [Web Server Log Analysis](assets.md#web-server-log-analysis)
  * [Network Device Log Analysis](assets.md#network-device-log-analysis)
  * [Syslog](assets.md#syslog)
  * [Sysmon](assets.md#sysmon)
  * [Splunk](assets.md#splunk)
  * [DeepBlueCLI](assets.md#deepbluecli)
  * [Sysinternals](assets.md#sysinternals)
  * [SIFT Workstation](assets.md#sift-workstation)
  * [Other Tools](assets.md#other-tools)
...
* MITRE ATT\&CK Framework Stages: [https://attack.mitre.org/matrices/enterprise/](https://attack.mitre.org/matrices/enterprise/)
...
* Execution technique examples: [https://attack.mitre.org/tactics/TA0002/](https://attack.mitre.org/tactics/TA0002/)
...
* Persistence examples: [https://attack.mitre.org/tactics/TA0003/](https://attack.mitre.org/tactics/TA0003/)
  * [Boot or Logon Autostart Execution](https://attack.mitre.org/techniques/T1547/)
  * [External Remote Services](https://attack.mitre.org/techniques/T1133/)
    * EG SSH, FTP, VPN
* Privilege escalation examples: [https://attack.mitre.org/tactics/TA0004/](https://attack.mitre.org/tactics/TA0004/)
  * [Valid Accounts](https://attack.mitre.org/techniques/T1078/)
    * Obtaining valid accounts (eg via phishing)
  * [Exploitation for Privilege Escalation](https://attack.mitre.org/techniques/T1068/)
* Defense evasion: [https://attack.mitre.org/tactics/TA0005/](https://attack.mitre.org/tactics/TA0005/)
  ...
  * Indicator removal:
    ...
    * Timestomping
* Credential access: [https://attack.mitre.org/tactics/TA0006/](https://attack.mitre.org/tactics/TA0006/)
  ...
  * [Brute Force](https://attack.mitre.org/techniques/T1110/)
    * Hashcat can be used to attack encrupted passwords using brute force: [https://hashcat.net/hashcat/](https://hashcat.net/hashcat/)
    * Mitigations: account lockout policies, better passwords, MFA, log monitoring
* Discovery: [https://attack.mitre.org/tactics/TA0007/](https://attack.mitre.org/tactics/TA0007/)
  * Account discovery:
  ...
  * Lateral movement: [https://attack.mitre.org/tactics/TA0008/](https://attack.mitre.org/tactics/TA0008/)
...
* Collection: [https://attack.mitre.org/tactics/TA0009/](https://attack.mitre.org/tactics/TA0009/)
  * Email collection
  * Audio capture
  * Screen capture
...
* Command and control: [https://attack.mitre.org/tactics/TA0011/](https://attack.mitre.org/tactics/TA0011/)
...
* Exfiltration: [https://attack.mitre.org/tactics/TA0010/](https://attack.mitre.org/tactics/TA0010/)
  * Exfil Over C2 Channel
    * Mitigation: frequency analysis
  * Scheduled transfer
    * Mitigation: NIPS/NIDS
* Impact: [https://attack.mitre.org/tactics/TA0040/](https://attack.mitre.org/tactics/TA0040/)
...
* Installation: download from [https://www.wireshark.org/#download](https://www.wireshark.org/#download)
* Usage
  ...
  * Basic Display Filter Examples
    ...
    * More Display Filters here: [https://wiki.wireshark.org/DisplayFilters](https://wiki.wireshark.org/DisplayFilters)
...
* Email anslysis resources
  * Domain/IP Lookup: [https://whois.domaintools.com/](https://whois.domaintools.com/)
  * Domain Registration Lookup: [https://lookup.icann.org/en](https://lookup.icann.org/en)
  * URL Analysis: [https://urlhaus.abuse.ch/](https://urlhaus.abuse.ch/)
  * Show root HTTP Response: [https://www.wannabrowser.net/](https://www.wannabrowser.net/)
  * Reverse IP Lookup: [https://mxtoolbox.com/ReverseLookup.aspx](https://mxtoolbox.com/ReverseLookup.aspx)
  * IP Geolocation: [https://www.iplocation.net/](https://www.iplocation.net/)
  * URL Sandbox: [https://urlscan.io/](https://urlscan.io/)
  * Track reported phishing data: [https://phishtank.org/](https://phishtank.org/)
  * Virustotal Malware Analysis: [https://www.virustotal.com/gui/home/upload](https://www.virustotal.com/gui/home/upload)
  * Talos Malware Analysis: [https://talosintelligence.com/talos\_file\_reputation](https://talosintelligence.com/talos_file_reputation)
  * Hybrid Analysis Malware Analysis: [https://www.hybrid-analysis.com/](https://www.hybrid-analysis.com/)
...
* Windows
  ...
  * PowerShell Get-FileMetaData Function: [https://gist.github.com/woehrl01/5f50cb311f3ec711f6c776b2cb09c34e](https://gist.github.com/woehrl01/5f50cb311f3ec711f6c776b2cb09c34e)
* Linux
  * `ls -lisap <file>`
  * `stat <file>`
...
* Jump list: jump lists enable identification of filetypes automaticDestination-ms and customDestination-ms which show application pinned to the taskbar
  ...
  * Use JumpList Explorer: [https://www.sans.org/tools/jumplist-explorer/](https://www.sans.org/tools/jumplist-explorer/)
* Browsers
  * Artifacts
    * Cookies
      * Favorites
...
* Artifacts from recycle bin
  ...
  * Reference: [https://df-stream.com/2016/04/fun-with-recycle-bin-i-files-windows-10/](https://df-stream.com/2016/04/fun-with-recycle-bin-i-files-windows-10/)
* Processes
  * Reference: [https://www.socinvestigation.com/important-windows-processes-for-threat-hunting/](https://www.socinvestigation.com/important-windows-processes-for-threat-hunting/)
...
* Installation: can be downloaded from [https://accessdata.com/product-download-page](https://accessdata.com/product-download-page)
* Usage
...
* Windows Installation: download from [https://exiftool.org/](https://exiftool.org/)
* Usage
...
* Installation: download from [https://www.kroll.com/en/services/cyber-risk/incident-response-litigation-support/kroll-artifact-parser-extractor-kape](https://www.kroll.com/en/services/cyber-risk/incident-response-litigation-support/kroll-artifact-parser-extractor-kape)
...
* Installation: download program at [https://www.mitec.cz/wfa.html](https://www.mitec.cz/wfa.html)
...
* Installation: download program at [https://ericzimmerman.github.io/#!index.md](https://ericzimmerman.github.io/#!index.md)
* Usage:
...
* Installation: can be downloaded from [https://www.sans.org/tools/jumplist-explorer/](https://www.sans.org/tools/jumplist-explorer/)
...
* Installation: download program from [https://www.foxtonforensics.com/browser-history-capturer/](https://www.foxtonforensics.com/browser-history-capturer/)
...
* Installation: download program from [https://www.foxtonforensics.com/browser-history-viewer/](https://www.foxtonforensics.com/browser-history-viewer/)
...
* Description: used for memory forensics and has the following capabilities:
  ...
  * Export processes
* Installation:
  * Can be downloaded and installed from [https://www.volatilityfoundation.org/releases](https://www.volatilityfoundation.org/releases)
...
* Description: comprehensive forensics tool that has the following capabilities:
  ...
  * Android support
* Installation: can be downloaded from [https://www.autopsy.com/download/](https://www.autopsy.com/download/)
...
* Installation
  * On Linux: download tar file from [https://github.com/virustotal/yara/releases/tag/v4.0.2](https://github.com/virustotal/yara/releases/tag/v4.0.2)
...
* Usage
  * Write YARA Rules: [https://yara.readthedocs.io/en/stable/writingrules.html](https://yara.readthedocs.io/en/stable/writingrules.html)
  ...
  * YarGen to automatically generate rules for files: [https://github.com/Neo23x0/yarGen/releases](https://github.com/Neo23x0/yarGen/releases)
    * Installation
...
* Resources:
  ...
  * [https://yara.readthedocs.io/en/stable/commandline.html](https://yara.readthedocs.io/en/stable/commandline.html)
...
* Installation: download from [https://learn.microsoft.com/en-us/sysinternals/downloads/sysmon](https://learn.microsoft.com/en-us/sysinternals/downloads/sysmon)
...
* Installation: download from [https://www.splunk.com/en\_us/products/splunk-enterprise.html](https://www.splunk.com/en_us/products/splunk-enterprise.html)
* Usage
  ...
  * Advanced SPL Examples (more can be found at [https://github.com/EvolvingSysadmin/Splunk-Tools](https://github.com/EvolvingSysadmin/Splunk-Tools))
...
* Installation: download from [https://github.com/sans-blue-team/DeepBlueCLI](https://github.com/sans-blue-team/DeepBlueCLI)
...
* Installation: download from [https://learn.microsoft.com/en-us/sysinternals/downloads/](https://learn.microsoft.com/en-us/sysinternals/downloads/)
  * Also an online version available: [https://live.sysinternals.com/](https://live.sysinternals.com/)
* Usage
...
* Installation: download from [https://github.com/teamdfir/sift-cli#installation](https://github.com/teamdfir/sift-cli#installation) for installation on Ubuntu follow: [https://www.youtube.com/watch?v=lxLXTdLqgas](https://www.youtube.com/watch?v=lxLXTdLqgas)
* Usage
* Resources
...
* GitTools
* Nuclei
* [https://linuxhint.com/kali\_linux\_top\_forensic\_tools/](https://linuxhint.com/kali_linux_top_forensic_tools/)
* TODO:
